...
import com.kfp.aams.domain.dailyadvisory.service.ProposalService;
...
public class ProposalController {
    ...
    @GetMapping({ "/views/w_proposal", "/views/dailyadvisory/w_proposal" })
    public String viewProposal(@AuthenticationPrincipal UserPrincipal principal,
        ...
        return "views/dailyadvisory/w_proposal";
    }
