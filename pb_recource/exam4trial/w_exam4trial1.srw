forward
global type w_exam4trial1 from w_window1st5cn
end type
type tv_empl from pf_u_treeview within w_exam4trial1
end type
type p_2 from picture within w_exam4trial1
end type
type st_2 from pf_u_statictext within w_exam4trial1
end type
type cbx_expand from pf_u_checkbox within w_exam4trial1
end type
type dw_empl from fw_u_dwo within w_exam4trial1
end type
type cb_2 from pf_u_commandbutton within w_exam4trial1
end type
type cb_1 from pf_u_commandbutton within w_exam4trial1
end type
type cb_pic_sample from pf_u_commandbutton within w_exam4trial1
end type
type tab_1 from tab within w_exam4trial1
end type
type tabpage_1 from userobject within tab_1
end type
type dw_info1 from fw_u_dwo within tabpage_1
end type
type tabpage_1 from userobject within tab_1
dw_info1 dw_info1
end type
...
type dw_info2 from fw_u_dwo within tabpage_2
end type
type tabpage_2 from userobject within tab_1
dw_info2 dw_info2
end type
...
type dw_info3 from fw_u_dwo within tabpage_3
end type
type tabpage_3 from userobject within tab_1
dw_info3 dw_info3
end type
...
type uo_tab from pf_u_tab within w_exam4trial1
end type
type uo_2 from fw_u_dw2subbtn within w_exam4trial1
end type
end forward
...
global w_exam4trial1 w_exam4trial1

type variables
Datawindow		dw_tab1, dw_tab2, dw_tab3
ads_jTier			ids_empl
...
public subroutine wf_photo_view (string as_emp_id);String		ls_file_path, ls_file_ext
...
public subroutine wf_photo_sample (string as_id);String		ls_file_path, ls_file_ext
Long		ll_filesizes, ll_handle
Blob		lb_file
...
this.Control[iCurrent+4]=this.cbx_expand
this.Control[iCurrent+5]=this.dw_empl
this.Control[iCurrent+6]=this.cb_2
this.Control[iCurrent+7]=this.cb_1
this.Control[iCurrent+8]=this.cb_pic_sample
this.Control[iCurrent+9]=this.tab_1
this.Control[iCurrent+10]=this.uo_tab
this.Control[iCurrent+11]=this.uo_2
end on

on w_exam4trial1.destroy
call super::destroy
...
event wue_postopen;call super::wue_postopen;dw_tab1.settransobject(sqlca)
dw_tab2.settransobject(sqlca)
dw_tab3.settransobject(sqlca)
...
event wue_setdddw;call super::wue_setdddw;datawindowchild		ldwc_dddw

fw_f_setdddw(dw_empl, 'emp_cd', {gnv_vari.is_sys_id, gnv_vari.is_lang_type, 'EMP006', '%'})
...
event wue_clear;call super::wue_clear;dw_tab1= tab_1.tabpage_1.dw_info1
dw_tab2= tab_1.tabpage_2.dw_info2
dw_tab3= tab_1.tabpage_3.dw_info3

ids_empl = create ads_jTier
ids_empl.dataobject = 'd_bzinsa01_02_ds1_spc'
ids_empl.settransobject(sqlca)
end event

type lb_dirlist from w_window1st5cn`lb_dirlist within w_exam4trial1
end type

type ln_templeft from w_window1st5cn`ln_templeft within w_exam4trial1
end type

type ln_tempbuttom from w_window1st5cn`ln_tempbuttom within w_exam4trial1
end type

type ln_temptop from w_window1st5cn`ln_temptop within w_exam4trial1
end type

type ln_tempbutton from w_window1st5cn`ln_tempbutton within w_exam4trial1
end type

type ln_tempstart from w_window1st5cn`ln_tempstart within w_exam4trial1
end type

type ln_cond1_yline from w_window1st5cn`ln_cond1_yline within w_exam4trial1
end type

type ln_dw1_yline from w_window1st5cn`ln_dw1_yline within w_exam4trial1
end type

type ln_cond2_yline from w_window1st5cn`ln_cond2_yline within w_exam4trial1
end type

type ln_dw2_yline from w_window1st5cn`ln_dw2_yline within w_exam4trial1
end type

type ln_tempright from w_window1st5cn`ln_tempright within w_exam4trial1
end type

type uo_navi from w_window1st5cn`uo_navi within w_exam4trial1
end type

type ln_temptop_shadow from w_window1st5cn`ln_temptop_shadow within w_exam4trial1
end type

type st_windelaytime from w_window1st5cn`st_windelaytime within w_exam4trial1
end type

type p_close from w_window1st5cn`p_close within w_exam4trial1
end type

type p_excel from w_window1st5cn`p_excel within w_exam4trial1
end type

type p_print from w_window1st5cn`p_print within w_exam4trial1
end type

type p_delete from w_window1st5cn`p_delete within w_exam4trial1
end type

type p_update from w_window1st5cn`p_update within w_exam4trial1
end type

type p_input from w_window1st5cn`p_input within w_exam4trial1
end type

type p_retrieve from w_window1st5cn`p_retrieve within w_exam4trial1
end type

type p_clear from w_window1st5cn`p_clear within w_exam4trial1
end type

type dw_cond from w_window1st5cn`dw_cond within w_exam4trial1
end type
...
tab_1.tabpage_1.dw_info1.retrieve(gnv_vari.is_sys_id, ls_dept_cd)
...
integer height = 64
boolean bringtotop = true
string picturename = "..\img\controls\u_icon4comm\icon_breadcrumb3.jpg"
...
boolean bringtotop = true
string title = "직원상세정보"
string dataobject = "d_exam4trial1_1"
...
Else //신규등록
	...
	Values (:gnv_vari.is_sys_id, :ls_emp_id,  :ll_filebytes, :ls_picpath, :ls_datetime, :gnv_vari.is_user_id, :ls_datetime);
End If
...
event clicked;call super::clicked;String		ls_picnm, ls_picpath, ls_datetime, ls_SqlErrText
Long		ll_filebytes, ll_tmp_cnt
integer	li_value
Blob		lb_pic_file
...
Else //신규등록
	Insert Into fw_empl_pic (sys_id, emp_id, file_size, file_path, save_date, reg_id,  reg_dt)
	Values (:gnv_vari.is_sys_id, 'admin',  :ll_filebytes, :ls_picpath, :ls_datetime, :gnv_vari.is_user_id, :ls_datetime);
End If
IF Sqlca.Sqlcode() <> 0 Then
	Messagebox('Notice', 'Employee photo registration 1 error. ~r~n' + &
							 'Error code ' + STRING(SQLCA.SQLCODE()) + ' ~r~n' + &	
...
on tabpage_1.create
this.dw_info1=create dw_info1
this.Control[]={this.dw_info1}
end on

on tabpage_1.destroy
destroy(this.dw_info1)
end on
...
integer height = 792
integer taborder = 150
string dataobject = "d_exam4trial1_2"
boolean scaletoright = true
boolean scaletobottom = true
boolean applydesign = true
boolean useborder = true
...
string text = "가족정보"
long tabtextcolor = 33554432
long tabbackcolor = 33225466
long picturemaskcolor = 536870912
dw_info2 dw_info2
end type

on tabpage_2.create
this.dw_info2=create dw_info2
this.Control[]={this.dw_info2}
end on

on tabpage_2.destroy
destroy(this.dw_info2)
end on
...
on tabpage_3.create
this.dw_info3=create dw_info3
this.Control[]={this.dw_info3}
end on

on tabpage_3.destroy
destroy(this.dw_info3)
end on
