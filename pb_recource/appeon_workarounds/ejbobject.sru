...
Function long RegDs (LONG nConnID,  ads_jTier data , LONG nSize) Library "eonejbclient.dll" alias for "RegDs;Ansi"
Function long RegDsArray (LONG nConnID,   ads_jTier data[], LONG length[], LONG arrSize) Library "eonejbclient.dll" alias for "RegDsArray;Ansi"
...
public function string regds (ads_jTier data)
public function string regdsarray (ads_jTier data[])
...
public function string invokeretds (long objid, string methodname, boolean autoremove, ref ads_jTier retval)
public function string invokeretdsarray (long objid, string methodname, boolean autoremove, ref ads_jTier retval[])
public function string ejbsharedata (datawindow dwdes, blob data, boolean reset)
public function string ejbsharedata (ads_jTier dsdes, blob data, boolean reset)
