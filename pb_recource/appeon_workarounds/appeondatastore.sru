...
// Copyright ? 2001-2006 Appeon, Inc. and its subsidiaries.  All rights reserved.
//////////////////////////////////////////////////////////////////////////////
ads_jTier lds_RowState,lds_RowFlag
...
if as_column = '' then
	choose case adw_buffer
		...
		case filter!
			...
			//Creates ads_jTier instance lds_obj; assigns data of the current DataObject in filter buffer 
...
// 
//------------------------------------------------------------------------------
// Function: appeonads_jTier::of_getfullstate()
//------------------------------------------------------------------------------
// Description: 
// 
//	
