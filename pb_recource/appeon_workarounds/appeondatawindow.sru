...
// 
//------------------------------------------------------------------------------
// Function: appeonads_jTier::of_initrowflag()
//------------------------------------------------------------------------------
...
ads_jTier	 lds_data, lds_status, lds_SRowFlag, lds_SRowInfo

// no data
IF as_data = "" THEN Return 0

// import source datawindow state into to lds_status
lds_status = CREATE ads_jTier
...
ads_jTier ds_RowInfo, ds_RowFlag
