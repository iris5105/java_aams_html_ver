forward
global type u_exam4uotab1_page1 from u_ancestor
end type
type dw_list from fw_u_dwo within u_exam4uotab1_page1
end type
end forward
...
global u_exam4uotab1_page1 u_exam4uotab1_page1

on u_exam4uotab1_page1.create
int iCurrent
call super::create
...
on u_exam4uotab1_page1.destroy
call super::destroy
...
integer taborder = 10
string title = "test1"
string dataobject = "u_exam4uotab1_page1_1"
