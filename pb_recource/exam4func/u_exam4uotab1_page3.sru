forward
global type u_exam4uotab1_page3 from u_ancestor
end type
type dw_list2 from fw_u_dwo within u_exam4uotab1_page3
end type
type st_v from pf_u_splitbar_vertical within u_exam4uotab1_page3
end type
type dw_list from fw_u_dwo within u_exam4uotab1_page3
end type
end forward
...
global u_exam4uotab1_page3 u_exam4uotab1_page3

on u_exam4uotab1_page3.create
int iCurrent
call super::create
...
on u_exam4uotab1_page3.destroy
call super::destroy
...
event resize;call super::resize;long ll_dwheightminus1value
...
st_v.y = dw_list.y
st_v.height = dw_list.height // - Long(PixelsToUnits(7, XPixelsToUnits!))
