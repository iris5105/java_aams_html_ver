forward
global type w_response1st1cn from w_response1st
end type
type p_print from pf_u_imagebutton within w_response1st1cn
end type
type p_delete from pf_u_imagebutton within w_response1st1cn
end type
type p_new from pf_u_imagebutton within w_response1st1cn
end type
type p_close from pf_u_imagebutton within w_response1st1cn
end type
type p_cancel from pf_u_imagebutton within w_response1st1cn
end type
type p_ok from pf_u_imagebutton within w_response1st1cn
end type
type p_preview from pf_u_imagebutton within w_response1st1cn
end type
type p_update from pf_u_imagebutton within w_response1st1cn
end type
type p_excel from pf_u_imagebutton within w_response1st1cn
end type
type dw_cond from fw_u_dwo within w_response1st1cn
end type
type p_clear from pf_u_imagebutton within w_response1st1cn
end type
type p_modify from pf_u_imagebutton within w_response1st1cn
end type
type p_retrieve from pf_u_imagebutton within w_response1st1cn
end type
type p_tempsave from pf_u_imagebutton within w_response1st1cn
end type
type p_collect from pf_u_imagebutton within w_response1st1cn
end type
type p_select from pf_u_imagebutton within w_response1st1cn
end type
type p_find from pf_u_imagebutton within w_response1st1cn
end type
type p_execu from pf_u_imagebutton within w_response1st1cn
end type
type p_enroll from pf_u_imagebutton within w_response1st1cn
end type
end forward
...
global w_response1st1cn w_response1st1cn
...
type ln_tempbutton from w_response1st`ln_tempbutton within w_response1st1cn
end type

type ln_tempstart from w_response1st`ln_tempstart within w_response1st1cn
end type

type ln_templeft from w_response1st`ln_templeft within w_response1st1cn
end type

type ln_cond_start from w_response1st`ln_cond_start within w_response1st1cn
end type

type ln_tempright from w_response1st`ln_tempright within w_response1st1cn
end type

type ln_cond1_yline from w_response1st`ln_cond1_yline within w_response1st1cn
end type

type ln_dw1_yline from w_response1st`ln_dw1_yline within w_response1st1cn
end type
