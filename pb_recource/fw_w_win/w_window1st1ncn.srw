forward
global type w_window1st1ncn from w_window1st
end type
type p_close from pf_u_imagebutton within w_window1st1ncn
end type
type p_excel from pf_u_imagebutton within w_window1st1ncn
end type
type p_print from pf_u_imagebutton within w_window1st1ncn
end type
type p_delete from pf_u_imagebutton within w_window1st1ncn
end type
type p_update from pf_u_imagebutton within w_window1st1ncn
end type
type p_input from pf_u_imagebutton within w_window1st1ncn
end type
type p_retrieve from pf_u_imagebutton within w_window1st1ncn
end type
type p_clear from pf_u_imagebutton within w_window1st1ncn
end type
type p_copy from pf_u_imagebutton within w_window1st1ncn
end type
end forward
...
global w_window1st1ncn w_window1st1ncn
...
public function string of_thisname ();return 'w_window1st1ncn'
end function

public subroutine of_initbutton ();pf_u_imagebutton	lpcbutton[9]

lpcbutton = { p_close, p_clear, p_retrieve, p_input, p_copy, p_delete, p_update, p_print, p_excel }
...
If gnv_authorbtn.ib_cpybtn_yn Then p_copy.visible		= True
...
public function boolean of_getcommbtnvisible (string as_btnname);pf_u_imagebutton	lpcbutton[8]
...
type lb_dirlist from w_window1st`lb_dirlist within w_window1st1ncn
end type

type ln_templeft from w_window1st`ln_templeft within w_window1st1ncn
end type

type ln_tempbuttom from w_window1st`ln_tempbuttom within w_window1st1ncn
end type

type ln_temptop from w_window1st`ln_temptop within w_window1st1ncn
end type

type ln_tempbutton from w_window1st`ln_tempbutton within w_window1st1ncn
end type

type ln_tempstart from w_window1st`ln_tempstart within w_window1st1ncn
end type

type ln_cond1_yline from w_window1st`ln_cond1_yline within w_window1st1ncn
end type

type ln_dw1_yline from w_window1st`ln_dw1_yline within w_window1st1ncn
end type

type ln_cond2_yline from w_window1st`ln_cond2_yline within w_window1st1ncn
end type

type ln_dw2_yline from w_window1st`ln_dw2_yline within w_window1st1ncn
end type

type ln_tempright from w_window1st`ln_tempright within w_window1st1ncn
end type

type uo_navi from w_window1st`uo_navi within w_window1st1ncn
end type

type ln_temptop_shadow from w_window1st`ln_temptop_shadow within w_window1st1ncn
end type

type st_windelaytime from w_window1st`st_windelaytime within w_window1st1ncn
end type
