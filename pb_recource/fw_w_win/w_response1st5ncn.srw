forward
global type w_response1st5ncn from w_response1st
end type
type p_print from pf_u_imagebutton within w_response1st5ncn
end type
type p_delete from pf_u_imagebutton within w_response1st5ncn
end type
type p_new from pf_u_imagebutton within w_response1st5ncn
end type
type p_close from pf_u_imagebutton within w_response1st5ncn
end type
type p_cancel from pf_u_imagebutton within w_response1st5ncn
end type
type p_ok from pf_u_imagebutton within w_response1st5ncn
end type
type p_preview from pf_u_imagebutton within w_response1st5ncn
end type
type p_update from pf_u_imagebutton within w_response1st5ncn
end type
type p_excel from pf_u_imagebutton within w_response1st5ncn
end type
type p_clear from pf_u_imagebutton within w_response1st5ncn
end type
type p_modify from pf_u_imagebutton within w_response1st5ncn
end type
type p_retrieve from pf_u_imagebutton within w_response1st5ncn
end type
type p_tempsave from pf_u_imagebutton within w_response1st5ncn
end type
type p_collect from pf_u_imagebutton within w_response1st5ncn
end type
type p_select from pf_u_imagebutton within w_response1st5ncn
end type
type p_find from pf_u_imagebutton within w_response1st5ncn
end type
type p_execu from pf_u_imagebutton within w_response1st5ncn
end type
type p_enroll from pf_u_imagebutton within w_response1st5ncn
end type
end forward
...
global w_response1st5ncn w_response1st5ncn
...
this.Control[iCurrent+10]=this.p_clear
this.Control[iCurrent+11]=this.p_modify
this.Control[iCurrent+12]=this.p_retrieve
this.Control[iCurrent+13]=this.p_tempsave
this.Control[iCurrent+14]=this.p_collect
this.Control[iCurrent+15]=this.p_select
this.Control[iCurrent+16]=this.p_find
this.Control[iCurrent+17]=this.p_execu
this.Control[iCurrent+18]=this.p_enroll
end on

on w_response1st5ncn.destroy
call super::destroy
...
type ln_tempbutton from w_response1st`ln_tempbutton within w_response1st5ncn
end type

type ln_tempstart from w_response1st`ln_tempstart within w_response1st5ncn
end type

type ln_templeft from w_response1st`ln_templeft within w_response1st5ncn
end type

type ln_cond_start from w_response1st`ln_cond_start within w_response1st5ncn
end type

type ln_tempright from w_response1st`ln_tempright within w_response1st5ncn
end type

type ln_cond1_yline from w_response1st`ln_cond1_yline within w_response1st5ncn
end type

type ln_dw1_yline from w_response1st`ln_dw1_yline within w_response1st5ncn
end type
