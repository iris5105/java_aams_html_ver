forward
global type u_ja021h_t1 from utt_listdetail
end type
end forward

global type u_ja021h_t1 from utt_listdetail
end type
global u_ja021h_t1 u_ja021h_t1

on u_ja021h_t1.create
call super::create
end on

on u_ja021h_t1.destroy
call super::destroy
end on

type ln_temptop from utt_listdetail`ln_temptop within u_ja021h_t1
end type

type ln_tempstart from utt_listdetail`ln_tempstart within u_ja021h_t1
end type

type ln_templeft from utt_listdetail`ln_templeft within u_ja021h_t1
end type

type ln_cond_start from utt_listdetail`ln_cond_start within u_ja021h_t1
end type

type ln_tempright from utt_listdetail`ln_tempright within u_ja021h_t1
end type

type ln_cond1_yline from utt_listdetail`ln_cond1_yline within u_ja021h_t1
end type

type ln_dw1_yline from utt_listdetail`ln_dw1_yline within u_ja021h_t1
end type

type ln_tempbutton from utt_listdetail`ln_tempbutton within u_ja021h_t1
end type

type dw_pagelist from utt_listdetail`dw_pagelist within u_ja021h_t1
string dataobject = "d_ja021h_t11"
...
CHOOSE CASE dwo.name
   CASE "tr_ymd"
      IF datetime (date (mida (data,1,10)))<iu_wpage.idt_workdate And gaa.aams  Then
	...
	CASE 'g00'
		IF data='1'	Then
		   Object.tr_cd [row] = 'G00'
		Else
			IF LEFT (Object.fr_koscom_cd [row],5)=LEFT (Object.fr_koscom_cd [row],5)   Then
				Object.tr_cd [row] = 'G51'
			Else
				Object.tr_cd [row] = 'G53'
			End IF
		End IF
END CHOOSE
...
IF Object.xx_fr_jm_cd [row]=Object.xx_to_jm_cd [row]  Then
   f_setprotect (THIS, FALSE, { 'g00' })
Else
   f_setprotect (THIS, TRUE, { 'g00' })
End IF
end event
...
type dw_pagedetail from utt_listdetail`dw_pagedetail within u_ja021h_t1
...
type st_move from utt_listdetail`st_move within u_ja021h_t1
end type
