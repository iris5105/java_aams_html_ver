forward
global type u_ja021f_t2 from utt_listdetail
end type
end forward

global type u_ja021f_t2 from utt_listdetail
end type
global u_ja021f_t2 u_ja021f_t2

on u_ja021f_t2.create
call super::create
end on

on u_ja021f_t2.destroy
call super::destroy
end on

type ln_temptop from utt_listdetail`ln_temptop within u_ja021f_t2
end type

type ln_tempstart from utt_listdetail`ln_tempstart within u_ja021f_t2
end type

type ln_templeft from utt_listdetail`ln_templeft within u_ja021f_t2
end type

type ln_cond_start from utt_listdetail`ln_cond_start within u_ja021f_t2
end type

type ln_tempright from utt_listdetail`ln_tempright within u_ja021f_t2
end type

type ln_cond1_yline from utt_listdetail`ln_cond1_yline within u_ja021f_t2
end type

type ln_dw1_yline from utt_listdetail`ln_dw1_yline within u_ja021f_t2
end type

type ln_tempbutton from utt_listdetail`ln_tempbutton within u_ja021f_t2
end type

type dw_pagelist from utt_listdetail`dw_pagelist within u_ja021f_t2
string dataobject = "d_ja021f_t21"
...
event dw_pagelist::itemchanged_next;call super::itemchanged_next;STRING	ls_baej_mth, ls_balh_co
...
type dw_pagedetail from utt_listdetail`dw_pagedetail within u_ja021f_t2
string dataobject = "d_ja021f_t22"
end type
...
type st_move from utt_listdetail`st_move within u_ja021f_t2
end type
