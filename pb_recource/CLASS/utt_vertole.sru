forward
global type utt_vertole from u_subpage
end type
type dw_pagelist from u_dw within utt_vertole
end type
type ole_rd from u_rd within utt_vertole
end type
type st_move from pf_u_splitbar_vertical within utt_vertole
end type
type rb_onepage from pf_u_radiobutton within utt_vertole
end type
end forward
...
global utt_vertole utt_vertole
...
ole_rd.width  = this.width - dw_pagelist.x - dw_pagelist.width - st_move.width - Long(PixelsToUnits(10, XPixelsToUnits!))
ole_rd.height = dw_pagelist.height
...
type ln_temptop from u_subpage`ln_temptop within utt_vertole
end type

type ln_tempstart from u_subpage`ln_tempstart within utt_vertole
end type

type ln_templeft from u_subpage`ln_templeft within utt_vertole
end type

type ln_cond_start from u_subpage`ln_cond_start within utt_vertole
end type

type ln_tempright from u_subpage`ln_tempright within utt_vertole
end type

type ln_cond1_yline from u_subpage`ln_cond1_yline within utt_vertole
end type

type ln_dw1_yline from u_subpage`ln_dw1_yline within utt_vertole
end type

type ln_tempbutton from u_subpage`ln_tempbutton within utt_vertole
end type
...
string binarykey = "utt_vertole.udo"
