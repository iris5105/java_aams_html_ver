forward
global type wt_listshare from w_winpage
end type
type dw_list from u_dw within wt_listshare
end type
type dw_master from u_dw within wt_listshare
end type
end forward
...
global wt_listshare wt_listshare
...
type lb_dirlist from w_winpage`lb_dirlist within wt_listshare
end type

type ln_templeft from w_winpage`ln_templeft within wt_listshare
end type

type ln_tempbuttom from w_winpage`ln_tempbuttom within wt_listshare
end type

type ln_temptop from w_winpage`ln_temptop within wt_listshare
end type

type ln_tempbutton from w_winpage`ln_tempbutton within wt_listshare
end type

type ln_tempstart from w_winpage`ln_tempstart within wt_listshare
end type

type ln_cond1_yline from w_winpage`ln_cond1_yline within wt_listshare
end type

type ln_dw1_yline from w_winpage`ln_dw1_yline within wt_listshare
end type

type ln_cond2_yline from w_winpage`ln_cond2_yline within wt_listshare
end type

type ln_dw2_yline from w_winpage`ln_dw2_yline within wt_listshare
end type

type ln_tempright from w_winpage`ln_tempright within wt_listshare
end type

type uo_navi from w_winpage`uo_navi within wt_listshare
end type

type ln_temptop_shadow from w_winpage`ln_temptop_shadow within wt_listshare
end type

type st_windelaytime from w_winpage`st_windelaytime within wt_listshare
end type

type st_top_rect from w_winpage`st_top_rect within wt_listshare
end type

type p_close from w_winpage`p_close within wt_listshare
end type

type p_excel from w_winpage`p_excel within wt_listshare
end type

type p_print from w_winpage`p_print within wt_listshare
end type

type p_delete from w_winpage`p_delete within wt_listshare
end type

type p_update from w_winpage`p_update within wt_listshare
end type

type p_input from w_winpage`p_input within wt_listshare
end type

type p_retrieve from w_winpage`p_retrieve within wt_listshare
end type
...
type p_clear from w_winpage`p_clear within wt_listshare
end type

type p_copy from w_winpage`p_copy within wt_listshare
end type

type dw_c from w_winpage`dw_c within wt_listshare
end type

type btn_update from w_winpage`btn_update within wt_listshare
end type

type st_count from w_winpage`st_count within wt_listshare
end type
...
IF (rowcount >0 OR eb_null_line) OR NOT dw_Master.Visible	Then
	dw_Master.titlebar = TRUE
	dw_Master.of_setvisible (TRUE)
End IF
dw_Master.show ()
end event

event ue_copyrow;call super::ue_copyrow;dw_Master.of_setvisible (TRUE)
dw_Master.titlebar = TRUE
...
event updatestart;call super::updatestart;LONG  ll, lColCnt, lCol
...
event losefocus;call super::losefocus;//dw_List.EVENT losefocus ()
end event
...
event buttonup;call super::buttonup;IF	dwo.name='cb_ok'	Then
	of_setvisible (false)
