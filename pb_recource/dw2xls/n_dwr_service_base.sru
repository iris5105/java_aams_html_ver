...
public function integer of_do_static_x_markup (n_dwr_worksheet anv_sheet);any la_ret
Return la_ret

end function

public function integer of_register_dynamic2 (powerobject apo_requestor, long al_rowcount);any la_ret
Return la_ret
