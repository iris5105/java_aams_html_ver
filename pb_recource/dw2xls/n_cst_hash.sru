...
protected function integer of_extend_hash (long al_power);ulong ll_i, ll_old_size, ll_new_size, ll_new_pos, ll_start = 1
...
for ll_i = ll_start to ll_old_size
	lnvo_cur_entry = invo_fields[ll_i]
...
public function unsignedlong of_hash (readonly string as_key);ulong ll_i, ll_len, ll_start = 1
ulong ll_ret = 0

ll_len = Len(as_key)
for ll_i = ll_start to ll_len 
