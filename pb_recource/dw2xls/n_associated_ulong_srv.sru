...
public function unsignedlong of_get_key_index (unsignedlong al_val);ulong ll_i, ll_start = 1

for ll_i = ll_start to il_key_count
...
protected function unsignedlong of_get_index_min_key (unsignedlong al_from_key);ulong ll_ret = 0, ll_start = 1
ulong ll_i 
