...
Function LongLong CreateWindowExA(ulong dwExStyle, string as_ClassName, long WindowName, ulong dwStyle, ulong a_X, ulong a_Y, ulong nWidth, ulong nHeight, LongPtr hWndParent, LongPtr hMenu, LongPtr hInstance, LongPtr lpParam) library "user32.dll"




Function LongLong CreateWindowExW(ulong dwExStyle, string as_ClassName, long WindowName, ulong dwStyle, ulong a_X, ulong a_Y, ulong nWidth, ulong nHeight, LongPtr hWndParent, LongPtr hMenu, LongPtr hInstance, LongPtr lpParam) library "user32.dll"




Function integer DestroyWindow(LongPtr hWnd2) library "user32.dll"
...
hInstance = Handle(GetApplication())
