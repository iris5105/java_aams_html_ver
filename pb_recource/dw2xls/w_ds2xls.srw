...
forward prototypes
public function integer of_register_ds (ref ads_jTier ads_ds)
public function integer of_unregister_ds (ref ads_jTier ads_ds)
end prototypes

public function integer of_register_ds (ref ads_jTier ads_ds);integer li_ret = 1
...
public function integer of_unregister_ds (ref ads_jTier ads_ds);ads_ds.ShareDataOff()
return 1
end function
