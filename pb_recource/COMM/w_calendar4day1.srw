forward
global type w_calendar4day1 from window
end type
type dw_cal from fw_u_dwo within w_calendar4day1
end type
end forward
...
global w_calendar4day1 w_calendar4day1
...
on w_calendar4day1.create
this.dw_cal=create dw_cal
this.Control[]={this.dw_cal}
end on

on w_calendar4day1.destroy
destroy(this.dw_cal)
end on
