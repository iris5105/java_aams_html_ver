forward
global type w_ja035d_code from w_response_s
end type
end forward
...
global w_ja035d_code w_ja035d_code
...
on w_ja035d_code.create
call super::create
end on

on w_ja035d_code.destroy
call super::destroy
end on
...
type ln_tempbutton from w_response_s`ln_tempbutton within w_ja035d_code
end type

type ln_tempstart from w_response_s`ln_tempstart within w_ja035d_code
end type

type ln_templeft from w_response_s`ln_templeft within w_ja035d_code
end type

type ln_cond_start from w_response_s`ln_cond_start within w_ja035d_code
end type

type ln_tempright from w_response_s`ln_tempright within w_ja035d_code
end type

type ln_cond1_yline from w_response_s`ln_cond1_yline within w_ja035d_code
end type

type ln_dw1_yline from w_response_s`ln_dw1_yline within w_ja035d_code
end type

type dw_view from w_response_s`dw_view within w_ja035d_code
string dataobject = "d_ja035d_code"
end type
