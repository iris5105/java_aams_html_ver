forward
global type wt_vertole from w_winpage
end type
type dw_list from u_dw within wt_vertole
end type
type st_move from pf_u_splitbar_vertical within wt_vertole
end type
type ole_rd from u_rd within wt_vertole
end type
type rb_onepage from pf_u_radiobutton within wt_vertole
end type
end forward
...
type lb_dirlist from w_winpage`lb_dirlist within wt_vertole
end type

type ln_templeft from w_winpage`ln_templeft within wt_vertole
end type

type ln_tempbuttom from w_winpage`ln_tempbuttom within wt_vertole
end type

type ln_temptop from w_winpage`ln_temptop within wt_vertole
end type

type ln_tempbutton from w_winpage`ln_tempbutton within wt_vertole
end type

type ln_tempstart from w_winpage`ln_tempstart within wt_vertole
end type

type ln_cond1_yline from w_winpage`ln_cond1_yline within wt_vertole
end type

type ln_dw1_yline from w_winpage`ln_dw1_yline within wt_vertole
end type

type ln_cond2_yline from w_winpage`ln_cond2_yline within wt_vertole
end type

type ln_dw2_yline from w_winpage`ln_dw2_yline within wt_vertole
end type

type ln_tempright from w_winpage`ln_tempright within wt_vertole
end type

type uo_navi from w_winpage`uo_navi within wt_vertole
end type

type ln_temptop_shadow from w_winpage`ln_temptop_shadow within wt_vertole
end type

type st_windelaytime from w_winpage`st_windelaytime within wt_vertole
end type

type st_top_rect from w_winpage`st_top_rect within wt_vertole
end type

type p_close from w_winpage`p_close within wt_vertole
end type

type p_excel from w_winpage`p_excel within wt_vertole
end type

type p_print from w_winpage`p_print within wt_vertole
end type

type p_delete from w_winpage`p_delete within wt_vertole
end type

type p_update from w_winpage`p_update within wt_vertole
end type

type p_input from w_winpage`p_input within wt_vertole
end type

type p_retrieve from w_winpage`p_retrieve within wt_vertole
end type
...
type p_clear from w_winpage`p_clear within wt_vertole
end type

type p_copy from w_winpage`p_copy within wt_vertole
end type

type dw_c from w_winpage`dw_c within wt_vertole
end type

type btn_update from w_winpage`btn_update within wt_vertole
end type

type st_count from w_winpage`st_count within wt_vertole
end type
...
integer taborder = 40
boolean bringtotop = true
string binarykey = "wt_vertole.win"
