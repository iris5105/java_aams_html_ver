forward
global type fw_w_httpdownload from window
end type
type dw_2 from u_dw within fw_w_httpdownload
end type
type dw_1 from u_dw within fw_w_httpdownload
end type
type cb_close from pf_u_commandbutton within fw_w_httpdownload
end type
type st_4 from pf_u_statictext within fw_w_httpdownload
end type
type st_2 from pf_u_statictext within fw_w_httpdownload
end type
type hpb_file from hprogressbar within fw_w_httpdownload
end type
type st_msg from pf_u_statictext within fw_w_httpdownload
end type
type hpb_total from hprogressbar within fw_w_httpdownload
end type
type st_title from pf_u_statictext within fw_w_httpdownload
end type
type dw_filelist from fw_u_dwo within fw_w_httpdownload
end type
end forward
...
global fw_w_httpdownload fw_w_httpdownload
