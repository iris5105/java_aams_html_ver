forward
global type eon_mobile_imageex from eon_mobile_image
end type
end forward

global type eon_mobile_imageex from eon_mobile_image
end type
global eon_mobile_imageex eon_mobile_imageex
...
// 
//--------------------------------------------------------------------------------------------------------------------------------------------------------------
// Function: eon_mobile_imageex::of_createimagewithoptions
//--------------------------------------------------------------------------------------------------------------------------------------------------------------
// Description:
...
if appeongetclienttype() = "MOBILE" then
	li_return = super::of_createimagewithoptions(ablb_sourcefile,as_targetfile,astr_imageoption,astr_imageinfo)
else
	li_return = -1
end if
return li_return
...
if appeongetclienttype() = "MOBILE" then
	li_return = super::of_createimagewithoptions(as_sourcefile,as_targetfile,astr_imageoption,astr_imageinfo)
else
	li_return = -1
end if
...
on eon_mobile_imageex.create
call super::create
end on

on eon_mobile_imageex.destroy
call super::destroy
end on
