forward
global type w_window1st1cn from w_window1st
end type
type p_close from pf_u_imagebutton within w_window1st1cn
end type
type p_excel from pf_u_imagebutton within w_window1st1cn
end type
type p_print from pf_u_imagebutton within w_window1st1cn
end type
type p_delete from pf_u_imagebutton within w_window1st1cn
end type
type p_update from pf_u_imagebutton within w_window1st1cn
end type
type p_input from pf_u_imagebutton within w_window1st1cn
end type
type p_retrieve from pf_u_imagebutton within w_window1st1cn
end type
type p_clear from pf_u_imagebutton within w_window1st1cn
end type
type dw_cond from fw_u_dwo within w_window1st1cn
end type
end forward
...
global w_window1st1cn w_window1st1cn
...
public function string of_thisname ();return 'w_window1st1cn'
end function
...
type lb_dirlist from w_window1st`lb_dirlist within w_window1st1cn
end type

type ln_templeft from w_window1st`ln_templeft within w_window1st1cn
end type

type ln_tempbuttom from w_window1st`ln_tempbuttom within w_window1st1cn
end type

type ln_temptop from w_window1st`ln_temptop within w_window1st1cn
end type

type ln_tempbutton from w_window1st`ln_tempbutton within w_window1st1cn
end type

type ln_tempstart from w_window1st`ln_tempstart within w_window1st1cn
end type

type ln_cond1_yline from w_window1st`ln_cond1_yline within w_window1st1cn
end type

type ln_dw1_yline from w_window1st`ln_dw1_yline within w_window1st1cn
end type

type ln_cond2_yline from w_window1st`ln_cond2_yline within w_window1st1cn
end type

type ln_dw2_yline from w_window1st`ln_dw2_yline within w_window1st1cn
end type

type ln_tempright from w_window1st`ln_tempright within w_window1st1cn
end type

type uo_navi from w_window1st`uo_navi within w_window1st1cn
end type

type ln_temptop_shadow from w_window1st`ln_temptop_shadow within w_window1st1cn
end type

type st_windelaytime from w_window1st`st_windelaytime within w_window1st1cn
end type
